...
namespace FarmManager.Controllers
{
    public class PastoController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="CDTerra,NRVacasAlocadas,NRMaximoVacas,NRHectares")] Pasto pasto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="CDTerra,NRVacasAlocadas,NRMaximoVacas,NRHectares")] Pasto pasto)
        {
            if (ModelState.IsValid)
            {
